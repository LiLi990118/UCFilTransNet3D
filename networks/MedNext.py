...
def get_mednet():
    num_block = [2, 4, 4, 4, 4, 4, 4, 2, 2]
    scale = [2, 4, 4, 4, 4, 4, 2, 2, 2]
    net = MedNeXt(1, 32, 3, num_block, scale, 9)
    # in_channel, base_c, k_size, num_block, scale, num_class
    return net.cuda()
...
if __name__ == '__main__':
    ...
    print('FLOPs = ' + str(flops / 1000 ** 3) + 'G')  # 27.6035624G
    print('Params = ' + str(params / 1000 ** 2) + 'M')  # 15.36325M