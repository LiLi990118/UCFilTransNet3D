...
# C Support
# Enable the cython support for faster evaluation, this is necessary for speeding up your ResUnet results
...
class CityscapesEvaluator(object):
    ...
    def evaluate(self, pred_dir=None, gt_dir=None):
        """
        :param pred_dir: directory of ResUnet output results(must be consistent with val directory)
