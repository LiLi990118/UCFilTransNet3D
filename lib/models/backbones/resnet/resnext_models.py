...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        # This improves the ResUnet by 0.2~0.3% according to https://arxiv.org/abs/1706.02677
...
class ResNextModels(object):
    ...
    def resnext101_32x8d(self, **kwargs):
        """Constructs a ResNeXt-101 32x8d ResUnet.

        Args:
            pretrained (bool): If True, returns a ResUnet pre-trained on ImageNet
    ...
    def resnext101_32x16d(self, **kwargs):
        """Constructs a ResNeXt-101 32x16d ResUnet.
    ...
    def resnext101_32x32d(self, **kwargs):
        """Constructs a ResNeXt-101 32x32d ResUnet.
    ...
    def resnext101_32x48d(self, **kwargs):
        """Constructs a ResNeXt-101 32x48d ResUnet.
