...
parser.add_argument('--output', type=str, default='', required=True, help='Output folder for both tensorboard and the best ResUnet')
...
parser.add_argument('--pretrain_classes', type=int, default='', help='Number of classes output from pretrained ResUnet')
